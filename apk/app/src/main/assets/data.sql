...
INSERT INTO tasks (id, name, description, status, priority, start_date, end_date, flat_id) VALUES ('0f1b6714-1810-400b-9b96-205d8e8825fe', 'Tarea 1', 'Descripcion de la tarea 1', 1, 2, '2020-01-01', '2021-01-01', 'c06a7eeb-51d0-4b14-811a-b48048f94125');
INSERT INTO tasks (id, name, description, status, priority, start_date, end_date, flat_id) VALUES ('65cb899a-60a8-4832-b31d-313c69e736a5', 'Tarea 2', 'Descripcion de la tarea 2', 2, 0, '2020-01-01', '2020-01-31', '59f35c62-c24b-4991-984c-08b064abd34f');
...
INSERT INTO tasks (id, name, description, status, priority, start_date, end_date, flat_id) VALUES ('218dc2db-c932-413a-a24e-8c71a0d62679', 'Tarea 4', 'Descripcion de la tarea 4', 0, 1, '2020-02-08', '2020-04-31', 'c06a7eeb-51d0-4b14-811a-b48048f94125');
INSERT INTO tasks (id, name, description, status, priority, end_date, flat_id) VALUES ('b502efec-0185-4ad4-be36-6192e65143a6', 'Tarea 5', 'Descripcion de la tarea 5', 3, 0, '2021-05-20', 'b8b19dbb-2cc8-4deb-9078-c99f3ec1e480');
